...
echo "2. Follow the manual deployment guide: RENDER_MANUAL_DEPLOYMENT.md"
echo "3. Create services in this order:"
echo "   a) Backend API (Web Service): meddirect-backend"
echo "   b) Frontend (Static Site): meddirect-frontend" 
echo "   c) Admin Panel (Static Site): meddirect-admin"
echo ""
echo "📚 For detailed instructions, check:"
echo "- RENDER_MANUAL_DEPLOYMENT.md (Recommended step-by-step guide)"
echo "- README.md (Deployment section)"
echo "- RENDER_DEPLOYMENT_CHECKLIST.md (Verification checklist)"
echo ""
echo "⚠️  Note: Manual deployment is recommended over render.yaml for better control"
echo ""
