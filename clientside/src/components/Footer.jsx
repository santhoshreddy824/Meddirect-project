    ...
    <div className="px-4 sm:px-6 md:px-10 lg:px-20">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
        ...
        <div>
          ...
          <p className="w-full md:w-2/3 text-gray-600 leading-6">
            MedDirect is your trusted healthcare partner, connecting patients
            with qualified healthcare professionals. Our platform streamlines
            appointment booking and healthcare management for a better patient
            experience.
          </p>
        </div>
      ...
      <div>
        ...
        <p className="py-5 text-sm text-center">
          Copyright © 2025 MedDirect - All Right Reserved
        </p>
      </div>
    </div>
  );
