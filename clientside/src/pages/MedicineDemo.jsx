                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                    ...
                    <button
                      onClick={() =>
                        handleMedicineSelect({ name: "Aspirin", rxcui: "1191" })
                      }
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Aspirin</div>
                      <div className="text-sm text-gray-500">
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Mucinex</div>
                      <div className="text-sm text-gray-500">
                        Expectorant, mucus relief
                      </div>
                    </button>
                    <button
                      onClick={() =>
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Sudafed</div>
                      <div className="text-sm text-gray-500">
                        Nasal decongestant
                      </div>
                    </button>
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Benadryl</div>
                      <div className="text-sm text-gray-500">
                    ...
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Claritin</div>
                      <div className="text-sm text-gray-500">
                    ...
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Zyrtec</div>
                      <div className="text-sm text-gray-500">
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Tums</div>
                      <div className="text-sm text-gray-500">
                    ...
                    <button
                      ...
                      className="w-full text-left p-2 bg-gray-50 rounded hover:bg-blue-50 transition-colors"
                    >
                      <div className="font-medium text-blue-600">Prilosec</div>
                      <div className="text-sm text-gray-500">Acid reducer</div>
                    </button>
                  </div>
                </div>
              </div>

              {/* Quick Medicine Facts */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="bg-white rounded p-3">
                    ...
                    <div className="text-gray-600">
                      Available without prescription for common symptoms
                    </div>
                  </div>
                  <div className="bg-white rounded p-3">
                    <div className="font-medium text-blue-700 mb-1">
                    ...
                    <div className="text-gray-600">
                      Always follow dosage instructions and warnings
                    </div>
                  </div>
                  <div className="bg-white rounded p-3">
                    <div className="font-medium text-blue-700 mb-1">
                    ...
                    <div className="text-gray-600">
                      Ask pharmacists or doctors for guidance
                    </div>
                  </div>
                  <div className="bg-white rounded p-3">
                    <div className="font-medium text-blue-700 mb-1">
